...
const Fixture = bookshelf.Model.extend({
  ...
  home() {return this.belongsTo('TournamentParticipant', 'home') },
  away() {return this.belongsTo('TournamentParticipant', 'away') },
  virtuals: {
    homeTeamPoints() {return calculatePoints(this.get('result'), true) },
    awayTeamPoints() {return calculatePoints(this.get('result'), false) }
  }
})
